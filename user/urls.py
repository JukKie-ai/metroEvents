...
urlpatterns = [
    ...
    path('<user>/event', views.eventView.as_view(), name="event"),
    ...
    path('<user>/viewDetails/<id>', views.viewDetailsView, name="viewDetails"),
    path('<user>/joinEvent/<id>', views.joinEventView, name="joinEvent"),
